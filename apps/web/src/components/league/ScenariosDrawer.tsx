...
export function ScenariosDrawer(props: ScenariosDrawerProps) {
    ...
    <Drawer open={isOpen} onOpenChange={onClose}>
      <DrawerContent className="max-h-[80vh]">
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            <DrawerTitle>Week {props.week} Scenarios</DrawerTitle>
            <DrawerDescription>
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-base">
                    In the Running ({inRunningPeople.length})
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {remainingGames.map((game) => {
                    ...
                    return (
                      <div key={game.gid} className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="tiebreaker-mobile" className="text-sm">
                      Tiebreaker Score
                    </Label>
                    <Input
                      id="tiebreaker-mobile"
                      type="number"
